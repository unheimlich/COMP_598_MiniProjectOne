...
path = "C://Users//Suzin//Desktop//COMP598 Machine Learning//Project 1//COMP_598_MiniProjectOne//data//PartTwo//Scraped//"
 	#"/Users/kylebrumsted/Documents/School/Fall2015/COMP598/Project1/scraped/"
...
while unscrapedLinks:
    ...
    try:
        req = urllib.request.Request(url)          #make http request object
    except IOError as InvalidURL:
        print("[Scraper]:: Encountered malformed URL: "+url+". Will continue scraping...")
        scrapedLinks.add(url)
        continue
    # read html into the data variable
    with urllib.request.urlopen(req) as website:
        data = website.read()
